...
class MPU6050(object):     
    def __init__(self, bus=None, freq=None, sda=None, scl=None, addr=_MPU6050_ADDRESS):
        ...
        try:
            ...
            log(LOGGING_LEVEL_ERROR, i2c_err_str.format(self.addr))
            log(LOGGING_LEVEL_ERROR, error_msg, e)
            raise e
    ...
    def read_accel_data(self, g = False):         
        ...
        if accel_range == _ACC_RNG_2G:
            ...
            log(LOGGING_LEVEL_ERROR, "Unkown range - scaler set to _ACC_SCLR_2G")
            scaler = _ACC_SCLR_2G
    ...
    def read_gyro_data(self):
        ...
        if gyro_range == _GYR_RNG_250DEG:
            ...
            log(LOGGING_LEVEL_ERROR, "Unkown range - scaler set to _GYR_SCLR_250DEG")
            scaler = _GYR_SCLR_250DEG
